...
#this version seeks to gain better results by training 
#on data specific to each scenario.
#more data from these videos to unlabled
#0 -> 5
#1 -> 6
#2 -> 7
#3 -> 8
...
#thinking plotting loss at the end to see if the model is overfitting
#
...
cap0 = cv2.VideoCapture("unlabeled/" + vlabel + ".hevc")
...
while index < 1199:
        sframes = 0
        print("video: ",vlabel," frame: ",index)
...
np.savetxt("unlabeled/" + vlabel + ".txt", answer)
